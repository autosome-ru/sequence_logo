...
# skipped parameters are also substituted as default (in example above icd_mode is default, and also scheme and threshold_lines)
...
options[:icd_mode], options[:revcomp], options[:scheme], options[:threshold_lines] = ARGV.shift(4)
