...
SequenceLogo.draw_logo(ppm, x_unit: 30, y_unit: 60, revcomp: 'direct').write(direct_output)
SequenceLogo.draw_logo(ppm, x_unit: 30, y_unit: 60, revcomp: 'revcomp').write(revcomp_output)